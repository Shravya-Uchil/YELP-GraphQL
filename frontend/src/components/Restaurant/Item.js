...
class Item extends Component {
  ...
  addToCart = (e) => {
    let item_id = this.props.menu_item.item_id || this.props.menu_item.id;
    let cartList = [];
  ...
  render() {
      ...
      itemButtons = (
        <div className='d-flex flex-row'>
          <Button
            ...
            name={this.props.menu_item.item_id || this.props.menu_item.id}
    ...
    if (this.state) {
      var imageSrc = `http://localhost:3002/yelp/images/item/${this.props.menu_item.item_image}`;
    }
    return (
      <div>
